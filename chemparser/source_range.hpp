...
public:
    ...
    constexpr source_range(std::string_view source, size_t start_position, size_t end_position);
...
constexpr source_range::source_range(std::string_view const source, size_t const start_position, size_t const end_position)
    : source_(source), start_position_(start_position), end_position_(end_position)
{
}
